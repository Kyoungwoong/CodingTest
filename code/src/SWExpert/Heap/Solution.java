...
public class Solution {
    ...
    private static int run() throws Exception {
        ...
        for(int i = 0; i < N; i++) {
            ...
            for(int k = 0; k < usersolution.heapCnt; k++){
                System.out.println(usersolution.heap.get(k).id + " " + usersolution.heap.get(k).income);
            }
    ...
    public static void main(String[] args) throws Exception {
        int TC;
        System.setIn(new java.io.FileInputStream("SW_Testcase/Heap/partial_sort.txt"));
